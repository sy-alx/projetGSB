...
<script>
    $(document).ready(() => {
        ...
        edit = (user) => {
            ...
            $("#btn-update").show();
            $("#btn-delete").attr("href", "/Addremplacant/Delete/" + $(user).attr("userid"));
...
<section>
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Gestion des remplacants</h6>
    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class = "margin-top row pb-3 pt-2 pl-100">
                ...
                <div class = "col-md-3 center">
                    <button class = "btn btn-info" data-toggle = "modal" data-target = "#add-user"><b>Ajouter un nouveau remplacant<i class = "fas fa-plus icon"></i></b></button>
                </div>
            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class = "form-group">
                                    ...
                                    <input class = "form-control" name = "nomRemplacant" required placeholder = "Ex: John Wick">
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">Prénom</label>
                                    <input class = "form-control" name = "prenomRemplacant" required >
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">Adresse</label>
                                    <input class = "form-control" name = "adresseRemplacant" required >
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">Code postal</label>
                                    <input class = "form-control" name = "codePostalRemplacant" required type = "number" >
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">Numéro</label>
                                    <input class = "form-control" name = "numeroRemplacant" required type = "number">
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">E-mail</label>
                                    <input class = "form-control" name = "emailRemplacant" required type = "email" placeholder = "Example: john@wick.com">
                                </div>
                            </div>
            ...
            <form method = "post" action = "/Addremplacant/Update">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class = "form-group">
                                    ...
                                    <input class = "form-control" name = "nomRemplacant" required placeholder = "Ex: John Wick" id = "edit-nom">
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">Prénom</label>
                                    <input class = "form-control" name = "prenomRemplacant" required id = "edit-prenom">
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">Adresse</label>
                                    <input class = "form-control" name = "adresseRemplacant" required id = "edit-adresse">
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">Code postal</label>
                                    <input class = "form-control" name = "codePostalRemplacant" required type = "number" id = "edit-codePostal">
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">Numéro</label>
                                    <input class = "form-control" name = "numeroRemplacant" required type = "number" id = "edit-numero">
                                </div>
                                <div class = "form-group">
                                    <label class = "light-dark">E-mail</label>
                                    <input class = "form-control" name = "emailRemplacant"  type = "email" placeholder = "Example: john@wick.com" id = "edit-email" required>
                                </div>
                            </div>
                            <div class="modal-footer">
                ...
                <table class = "table table-hover">
                    ...
                    <?php foreach($listeremplacant as $user) : if(!($user->id==1)){ ?>
                        <tr>
                            ...
                            <td><?= $user->adresseRemplacant?></td>
                            <td><?= $user->codePostalRemplacant?></td>
                            <td><?= $user->numeroRemplacant?></td>
                            <td><?= $user->emailRemplacant?></td>
                            <td>
                                <button usernom = "<?= $user->nomRemplacant ?>" userprenom = "<?= $user->prenomRemplacant ?>" useradresse = "<?= $user->adresseRemplacant ?>" usercodePostal = "<?= $user->codePostalRemplacant ?>" usernumero = "<?= $user->numeroRemplacant ?>" useremail = "<?= $user->emailRemplacant ?>" userid = "<?= $user->id ?>" onclick = "edit(this)" data-toggle = "modal" data-target = "#edit-user" class = "btn btn-sm btn-primary"><b><i class = "fas fa-bars"></i></b></button>
