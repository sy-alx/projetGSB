...
class VoirrdvModel extends Model
{
    ...
    public function getRdvData($startDate = null, $endDate = null) {
        ...
        $builder->select('rdv.date_rdv, rdv.heure_rdv, listePraticien.nom as nomPraticien, listePraticien.prenom as prenomPraticien, listePraticien.adresse, listePraticien.numero');
        if($startDate){
